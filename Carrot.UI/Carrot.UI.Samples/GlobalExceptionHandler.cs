...
namespace NotifierWidget {
    public class GlobalExceptionHandler {
        ...
        /// </summary>
        private static Exception ExtractExceptionObject(UnhandledExceptionEventArgs ex) {
            var e = ex.ExceptionObject as Exception ??
                new Exception($"AppDomainUnhandledException: Unknown exceptionobject: {ex.ExceptionObject}");
            Debug.WriteLine($"{e.GetType().Name} {e.StackTrace}");
            return e;
        }
    }
}
